...
int soma(int n1, int n2);   /* Nao esquecao de chamar a funcao antes de declarara */
...
/* Aqui pede para que o usuario digite um numero, assim ele amazerna o numero na variavel */ /* int porque a funcao vai retorna para funcao que chamo ela, n1 e como se fosse a variavel  */
